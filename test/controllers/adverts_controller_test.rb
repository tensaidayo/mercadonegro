...
class AdvertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advert" do
    assert_difference('Advert.count') do
      post adverts_url, params: { advert: { description: @advert.description, price: @advert.price, title: @advert.title } }
    end
  ...
  test "should update advert" do
    patch advert_url(@advert), params: { advert: { description: @advert.description, price: @advert.price, title: @advert.title } }
